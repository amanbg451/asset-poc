...
INSERT INTO "new_assets" ("asset_code", "asset_name", "assigned_to", "category", "created_at", "created_by", "description", "id", "location_id", "purchase_amount", "purchase_date", "status", "updated_at") SELECT "asset_code", "asset_name", "assigned_to", "category", "created_at", "created_by", "description", "id", "location_id", "purchase_amount", "purchase_date", "status", "updated_at" FROM "assets";
DROP TABLE "assets";
