...
export async function PUT(
  ...
  try {
    ...
    if (oldAsset.asset_name !== asset.asset_name) {
      changes.push({
        field: "asset_name",
        old: oldAsset.asset_name,
        new: asset.asset_name,
      });
    }
    ...
    if (oldAsset.location_id !== asset.location_id) {
      changes.push({
        field: "location_id",
        old: oldAsset.location_id,
        new: asset.location_id,
      });
    }
    if (oldAsset.department_id !== asset.department_id) {
      changes.push({
        field: "department_id",
        old: oldAsset.department_id,
        new: asset.department_id,
      });
    }
    if (oldAsset.category_id !== asset.category_id) {
      changes.push({
        field: "category_id",
        old: oldAsset.category_id,
        new: asset.category_id,
      });
    }
    if (oldAsset.serial_no !== asset.serial_no) {
      changes.push({
        field: "serial_no",
        old: oldAsset.serial_no,
        new: asset.serial_no,
      });
    }
